...
def main():
    win = pygcurse.PygcurseWindow(40, 25, 'Japanese Practice Game')
    win.font = pygame.font.Font("cyberbit.ttf", 42)
    win.pygprint('Type in the word you see, mirroring the output.')
